...
export const Scrollhome = () => {
  ...
  return (
    <div className='w-[70wv] h-[60vh] bg-black mt-0  '>
        <div className='mt-0 h-full pl-[100px] pr-[100px]'>
            <Slider {...Settings}>
                { Data.map((d,index) => (
                    <div key={index} className='w-[100%] relative'>
                       <img className='h-full w-full ' src= {d.img}/>
                       <div className="text-box "  style={{ position: 'absolute', top: '50%',left: '15%',transform: 'translate(-50%, -50%)',
